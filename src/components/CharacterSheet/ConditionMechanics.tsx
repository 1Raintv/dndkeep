...
const CONDITION_MECHANICS: Record<string, MechanicReminder> = {
 ...
 ' Some spells with verbal components may be harder to cast',
 ],
 },
 Exhaustion: {
 title: ' Exhausted',
 ...
 ' Ends if grappler is incapacitated or you move out of reach',
 ],
 },
 Incapacitated: {
 title: ' Incapacitated',
 ...
 ' Still detectable by sound, smell, tracks',
 ],
 },
 Paralyzed: {
 title: ' Paralyzed',
 ...
 ' Attack rolls against you have Advantage',
 ' Any attack that hits within 5 ft is a critical hit',
 ' Can\'t move or speak',
 ' Can\'t take actions or reactions',
 ],
 },
 ...
 ' Movement costs double to stand up (half your speed)',
 ],
 },
 Restrained: {
 title: ' Restrained',
 ...
 color: '#8b6be8',
 reminders: [
 ' Taking damage requires CON save (DC = max(10, half damage))',
