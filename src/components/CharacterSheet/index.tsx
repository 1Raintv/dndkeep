   ...
   return (
     <div style={{ marginTop: 'var(--sp-3)' }}>
       ...
       {legacy && activeSpells.length > 0 && (
        ...
        {/* v2.510.0 — The standalone "SPECIES — {NAME}" block that
            previously lived here was a DUPLICATE of the species
            abilities already surfaced by ClassAbilitiesSection (its
            "Species Abilities" sub-section). Both rendered the same
            actionType-bearing traits in the Actions tab. Removed the
            duplicate; ClassAbilitiesSection is now the single source
            for species abilities (it carries the unified grid, charges,
            Feline Agility automation, and the Large Form level gate). */}
