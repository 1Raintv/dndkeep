...
import { useBattleMapStore, type Token, type SceneText, type SceneDrawing, type DrawingKind } from '../../lib/stores/battleMapStore';
...
import {
  ...
  BG_COLOR,
  TOKEN_COLORS, ALL_CONDITIONS, COND_COLOR, COND_ICON, COND_COLOR_HEX,
  SIZE_OPTIONS, tokenRadiusForSize, tokenFootprintCells, tokenInitials,
  pointSegmentDistance, type ContextMenuState,
 ...
 */
function ReachOverlayLayer(props: {
  viewport: Viewport | null;
  gridSizePx: number;
}) {
