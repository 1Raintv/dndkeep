          ...
          return (
            <div
              ...
              style={{
                ...
                borderColor: isDowned ? 'var(--color-blood)' : undefined,
              }}
            >
              <div style={{ display: 'flex', gap: 'var(--space-3)', alignItems: 'flex-start' }}>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-2)', marginBottom: 2 }}>
                    <span style={{ fontFamily: 'var(--font-heading)', fontWeight: 700, fontSize: 'var(--text-sm)', color: 'var(--text-primary)', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                      {m.name}
                    </span>
                    {m.inspiration && (
                      <span title="Has Inspiration" style={{ color: 'var(--color-amber)', fontSize: 12 }}>⭐</span>
                    )}
                    {isDowned && (
                      <span style={{ fontFamily: 'var(--font-heading)', fontSize: 9, color: 'var(--color-crimson-bright)', background: 'rgba(155,28,28,0.2)', padding: '1px 5px', borderRadius: 3, letterSpacing: '0.06em', textTransform: 'uppercase' }}>
                        Down
                      </span>
                    )}
                  </div>
                  ...
                  <div style={{ marginTop: 'var(--space-2)' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 2 }}>
                      <span style={{ fontFamily: 'var(--font-heading)', fontSize: 9, color: 'var(--text-muted)' }}>HP</span>
                      <span style={{ fontFamily: 'var(--font-heading)', fontSize: 9, color: hpColor }}>
                ...
                <div style={{ textAlign: 'center', flexShrink: 0 }}>
                  <div style={{ fontFamily: 'var(--font-heading)', fontWeight: 700, fontSize: 'var(--text-md)', color: 'var(--text-primary)' }}>
                    {m.armor_class}
                  </div>
                  <div style={{ fontFamily: 'var(--font-heading)', fontSize: 9, color: 'var(--text-muted)', letterSpacing: '0.06em' }}>AC</div>
                </div>
              </div>
