    ...
    <div ref={dropdownRef} style={{ position: 'relative' }}>
      ...
      >
        <div style={{ minWidth: 0 }}>
          {selectedFeat ? (
            <>
              <div style={{ fontWeight: 700, fontSize: 13, color: 'var(--c-gold-l)' }}>
                ✓ {selectedFeat.name}
              </div>
      ...
      {open && (
        <div style={{
          ...
          {/* Count */}
          <div style={{ padding: '5px 12px 3px', fontSize: 10, color: 'var(--t-3)' }}>
            {feats.length} feat{feats.length !== 1 ? 's' : ''} — click to expand, click Select to choose
          </div>
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    background: isSel ? 'rgba(212,160,23,0.06)' : 'transparent',
                  }}
                >
                  {/* Feat row — click to expand */}
                  <div
                    onClick={() => setExpanded(isExp ? null : feat.name)}
                    style={{
                      display: 'flex', alignItems: 'center', gap: 10,
                      padding: '9px 14px', cursor: 'pointer', minHeight: 44,
                    }}
          ...
          {selected && (
            <div style={{ padding: '8px 12px', borderTop: '1px solid var(--c-border)', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
