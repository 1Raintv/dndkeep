...
const SRD_SPECIES = [
  ...
  'Human', 'Orc', 'Tiefling', 'Half-Elf (SRD 5.1)', 'Half-Orc (SRD 5.1)',
];
      ...
      <div style={{ maxWidth: 760, margin: '0 auto', padding: '64px 48px' }}>
        ...
        <div style={{ marginBottom: 48 }}>
          <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: '0.12em', textTransform: 'uppercase', color: 'var(--t-3)', marginBottom: 16 }}>
            Legal · Creative Commons (CC-BY-4.0)
          </div>
          ...
          <p style={{ fontSize: 16, color: 'var(--t-2)', lineHeight: 1.75, maxWidth: 600 }}>
            DNDKeep uses game content from the System Reference Document 5.2.1 (2024 rules) and, for certain legacy content, the System Reference Document 5.1, both published by Wizards of the Coast under the Creative Commons Attribution 4.0 International License.
          </p>
        </div>
        ...
        <div style={{ background: 'var(--c-card)', border: '1px solid var(--c-border-m)', borderRadius: 'var(--r-xl)', padding: '32px', marginBottom: 32 }}>
          ...
          <div style={{ fontSize: 15, color: 'var(--t-2)', lineHeight: 1.8 }}>
            <p style={{ marginBottom: 12 }}>
              ...
              <a href="https://www.dndbeyond.com/srd" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--c-gold-l)' }}>
            ...
            <p style={{ marginBottom: 12 }}>
              This work also includes material taken from the System Reference Document 5.1 ("SRD 5.1") by Wizards of the Coast LLC and available at{' '}
        ...
        <div style={{ background: 'var(--c-card)', border: '1px solid var(--c-border)', borderRadius: 'var(--r-xl)', padding: '32px', marginBottom: 32 }}>
          ...
          <p style={{ fontSize: 14, color: 'var(--t-2)', lineHeight: 1.7, marginBottom: 20 }}>
            The following content in DNDKeep is derived from or based on the SRD 5.2.1 (and, where noted, the SRD 5.1):
          </p>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(200px, 1fr))', gap: 20 }}>
            ...
            <div>
              ...
              {['Spells (SRD entries)', 'Monsters (SRD entries)', 'Conditions', 'Equipment & armor rules', 'Ability score rules', 'Combat rules', 'Spell slot tables', 'Proficiency bonus', 'Saving throw rules'].map(s => (
                <div key={s} style={{ fontSize: 14, color: 'var(--t-2)', lineHeight: 1.8 }}>{s}</div>
              ))}
            </div>
          </div>
        ...
        <div style={{ fontSize: 13, color: 'var(--t-3)', lineHeight: 1.7, borderTop: '1px solid var(--c-border)', paddingTop: 24 }}>
          ...
          <p style={{ marginTop: 8 }}>
            Certain monsters and content that appear in the SRD may be associated with Wizards of the Coast trade dress and product identity not covered by the CC-BY-4.0 license; such content is used solely in accordance with the SRD 5.2.1 and SRD 5.1 as published.
          </p>
        </div>
