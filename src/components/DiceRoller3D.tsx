...
// ── Dice Skin System ──────────────────────────────────────────────────────────
// DiceSkin type + DICE_SKINS data live in src/data/diceSkins.ts so they can be
// imported without dragging in three.js + cannon-es. Re-exported here for
// backward compatibility with existing imports.
export { DICE_SKINS, type DiceSkin } from '../data/diceSkins';
...
export default function DiceRoller3D({event,onDismiss,onResult,skinId}:Props){
  ...
  return createPortal(
    <div ref={mountRef} onClick={onDismiss}
      ...
      style={{position:'fixed',inset:0,zIndex:30000,background:'rgba(0,0,0,0.08)',cursor:'pointer',overflow:'hidden'}}>
