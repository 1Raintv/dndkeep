...
export const MONSTERS: MonsterData[] = [
  ...
  // ── Common low-CR encounters ───────────────────────────────────────────────
  { id: 'cultist', name: 'Cultist', type: 'Humanoid', cr: '1/8', size: 'Medium', hp: 9, hp_formula: '2d8', ac: 12, ac_note: 'Leather Armor', speed: 30, str: 11, dex: 12, con: 10, int: 10, wis: 11, cha: 10, attack_name: 'Scimitar', attack_bonus: 3, attack_damage: '1d6 + 1', xp: 25 },
  { id: 'cult-fanatic', name: 'Cult Fanatic', type: 'Humanoid', cr: '2', size: 'Medium', hp: 33, hp_formula: '6d8 + 6', ac: 13, ac_note: 'Leather Armor', speed: 30, str: 11, dex: 14, con: 12, int: 10, wis: 13, cha: 14, attack_name: 'Dagger', attack_bonus: 4, attack_damage: '1d4 + 2', xp: 450 },
  { id: 'bandit-captain', name: 'Bandit Captain', type: 'Humanoid', cr: '2', size: 'Medium', hp: 65, hp_formula: '10d8 + 20', ac: 15, ac_note: 'Studded Leather', speed: 30, str: 15, dex: 16, con: 14, int: 14, wis: 11, cha: 14, attack_name: 'Scimitar', attack_bonus: 5, attack_damage: '1d6 + 3', xp: 450 },
  { id: 'spy', name: 'Spy', type: 'Humanoid', cr: '1', size: 'Medium', hp: 27, hp_formula: '6d8', ac: 12, speed: 30, str: 10, dex: 15, con: 10, int: 12, wis: 14, cha: 16, attack_name: 'Shortsword', attack_bonus: 4, attack_damage: '1d6 + 2', xp: 200 },
  { id: 'thug', name: 'Thug', type: 'Humanoid', cr: '1/2', size: 'Medium', hp: 32, hp_formula: '5d8 + 10', ac: 11, ac_note: 'Leather Armor', speed: 30, str: 15, dex: 11, con: 14, int: 10, wis: 10, cha: 11, attack_name: 'Mace', attack_bonus: 4, attack_damage: '1d6 + 2', xp: 100 },
  { id: 'veteran', name: 'Veteran', type: 'Humanoid', cr: '3', size: 'Medium', hp: 58, hp_formula: '9d8 + 18', ac: 17, ac_note: 'Splint', speed: 30, str: 16, dex: 13, con: 14, int: 10, wis: 11, cha: 10, attack_name: 'Longsword', attack_bonus: 5, attack_damage: '1d8 + 3', xp: 700 },
  { id: 'knight', name: 'Knight', type: 'Humanoid', cr: '3', size: 'Medium', hp: 52, hp_formula: '8d8 + 16', ac: 18, ac_note: 'Plate', speed: 30, str: 16, dex: 11, con: 14, int: 11, wis: 11, cha: 15, attack_name: 'Greatsword', attack_bonus: 5, attack_damage: '2d6 + 3', xp: 700 },
  { id: 'assassin', name: 'Assassin', type: 'Humanoid', cr: '8', size: 'Medium', hp: 78, hp_formula: '12d8 + 24', ac: 15, ac_note: 'Studded Leather', speed: 30, str: 11, dex: 16, con: 14, int: 13, wis: 11, cha: 10, attack_name: 'Shortsword', attack_bonus: 6, attack_damage: '1d6 + 3', xp: 3900 },

  // ── Beasts ─────────────────────────────────────────────────────────────────
  { id: 'black-bear', name: 'Black Bear', type: 'Beast', cr: '1/2', size: 'Medium', hp: 19, hp_formula: '3d8 + 6', ac: 11, ac_note: 'Natural Armor', speed: 40, str: 15, dex: 10, con: 14, int: 2, wis: 12, cha: 7, attack_name: 'Bite', attack_bonus: 3, attack_damage: '1d6 + 2', xp: 100 },
  { id: 'brown-bear', name: 'Brown Bear', type: 'Beast', cr: '1', size: 'Large', hp: 34, hp_formula: '4d10 + 12', ac: 11, ac_note: 'Natural Armor', speed: 40, str: 19, dex: 10, con: 16, int: 2, wis: 13, cha: 7, attack_name: 'Bite', attack_bonus: 5, attack_damage: '1d8 + 4', xp: 200 },
  { id: 'giant-wolf-spider', name: 'Giant Wolf Spider', type: 'Beast', cr: '1/4', size: 'Medium', hp: 11, hp_formula: '2d8 + 2', ac: 13, speed: 40, str: 12, dex: 16, con: 13, int: 3, wis: 12, cha: 4, attack_name: 'Bite', attack_bonus: 3, attack_damage: '1d6 + 1', xp: 50 },
  { id: 'giant-bat', name: 'Giant Bat', type: 'Beast', cr: '1/4', size: 'Large', hp: 22, hp_formula: '4d10', ac: 13, speed: 10, str: 15, dex: 16, con: 11, int: 2, wis: 12, cha: 6, attack_name: 'Bite', attack_bonus: 4, attack_damage: '1d6 + 2', xp: 50 },
  { id: 'dire-wolf', name: 'Dire Wolf', type: 'Beast', cr: '1', size: 'Large', hp: 37, hp_formula: '5d10 + 10', ac: 14, ac_note: 'Natural Armor', speed: 50, str: 17, dex: 15, con: 15, int: 3, wis: 12, cha: 7, attack_name: 'Bite', attack_bonus: 5, attack_damage: '2d6 + 3', xp: 200 },
  { id: 'giant-crocodile', name: 'Giant Crocodile', type: 'Beast', cr: '5', size: 'Huge', hp: 114, hp_formula: '12d12 + 36', ac: 14, ac_note: 'Natural Armor', speed: 30, str: 21, dex: 9, con: 17, int: 2, wis: 10, cha: 7, attack_name: 'Bite', attack_bonus: 8, attack_damage: '3d10 + 5', xp: 1800 },

  // ── Undead ─────────────────────────────────────────────────────────────────
  { id: 'specter', name: 'Specter', type: 'Undead', cr: '1', size: 'Medium', hp: 22, hp_formula: '5d8', ac: 12, speed: 0, str: 1, dex: 14, con: 11, int: 10, wis: 10, cha: 11, attack_name: 'Life Drain', attack_bonus: 4, attack_damage: '3d6', xp: 200 },
  { id: 'shadow', name: 'Shadow', type: 'Undead', cr: '1/2', size: 'Medium', hp: 16, hp_formula: '3d8 + 3', ac: 12, speed: 40, str: 6, dex: 14, con: 13, int: 6, wis: 10, cha: 8, attack_name: 'Strength Drain', attack_bonus: 4, attack_damage: '2d6 + 2', xp: 100 },
  { id: 'revenant', name: 'Revenant', type: 'Undead', cr: '5', size: 'Medium', hp: 136, hp_formula: '16d8 + 64', ac: 13, ac_note: 'Natural Armor', speed: 30, str: 18, dex: 14, con: 18, int: 13, wis: 16, cha: 18, attack_name: 'Fist', attack_bonus: 7, attack_damage: '2d6 + 4', xp: 1800 },
  { id: 'wraith', name: 'Wraith', type: 'Undead', cr: '5', size: 'Medium', hp: 67, hp_formula: '9d8 + 27', ac: 13, speed: 0, str: 6, dex: 16, con: 16, int: 12, wis: 14, cha: 15, attack_name: 'Life Drain', attack_bonus: 6, attack_damage: '4d8 + 3', xp: 1800 },
  { id: 'banshee', name: 'Banshee', type: 'Undead', cr: '4', size: 'Medium', hp: 58, hp_formula: '13d8', ac: 12, speed: 0, str: 1, dex: 14, con: 10, int: 12, wis: 11, cha: 17, attack_name: 'Corrupting Touch', attack_bonus: 4, attack_damage: '3d6', xp: 1100 },
  { id: 'flameskull', name: 'Flameskull', type: 'Undead', cr: '4', size: 'Tiny', hp: 40, hp_formula: '9d4 + 18', ac: 13, speed: 0, str: 1, dex: 17, con: 14, int: 16, wis: 10, cha: 11, attack_name: 'Fire Ray', attack_bonus: 5, attack_damage: '3d6', xp: 1100 },

  // ── Fiends & Celestials ────────────────────────────────────────────────────
  { id: 'imp', name: 'Imp', type: 'Fiend', cr: '1', size: 'Tiny', hp: 10, hp_formula: '3d4 + 3', ac: 13, speed: 20, str: 6, dex: 17, con: 13, int: 11, wis: 12, cha: 14, attack_name: 'Sting', attack_bonus: 5, attack_damage: '1d4 + 3', xp: 200 },
  { id: 'quasit', name: 'Quasit', type: 'Fiend', cr: '1', size: 'Tiny', hp: 7, hp_formula: '3d4', ac: 13, speed: 40, str: 5, dex: 17, con: 10, int: 7, wis: 10, cha: 10, attack_name: 'Claws', attack_bonus: 4, attack_damage: '1d4 + 3', xp: 200 },
  { id: 'hell-hound', name: 'Hell Hound', type: 'Fiend', cr: '3', size: 'Medium', hp: 45, hp_formula: '7d8 + 14', ac: 15, ac_note: 'Natural Armor', speed: 50, str: 17, dex: 12, con: 14, int: 6, wis: 13, cha: 6, attack_name: 'Bite', attack_bonus: 5, attack_damage: '1d8 + 3', xp: 700 },
  { id: 'bearded-devil', name: 'Bearded Devil', type: 'Fiend', cr: '3', size: 'Medium', hp: 52, hp_formula: '8d8 + 16', ac: 13, ac_note: 'Natural Armor', speed: 30, str: 16, dex: 15, con: 15, int: 9, wis: 11, cha: 11, attack_name: 'Glaive', attack_bonus: 5, attack_damage: '1d10 + 3', xp: 700 },
  { id: 'succubus', name: 'Succubus/Incubus', type: 'Fiend', cr: '4', size: 'Medium', hp: 66, hp_formula: '12d8 + 12', ac: 13, speed: 30, str: 8, dex: 17, con: 13, int: 15, wis: 12, cha: 20, attack_name: 'Claw', attack_bonus: 5, attack_damage: '1d6 + 3', xp: 1100 },

  // ── Elementals ────────────────────────────────────────────────────────────
  { id: 'air-elemental', name: 'Air Elemental', type: 'Elemental', cr: '5', size: 'Large', hp: 90, hp_formula: '12d10 + 24', ac: 15, speed: 0, str: 14, dex: 20, con: 14, int: 6, wis: 10, cha: 6, attack_name: 'Slam', attack_bonus: 8, attack_damage: '2d8 + 5', xp: 1800 },
  { id: 'earth-elemental', name: 'Earth Elemental', type: 'Elemental', cr: '5', size: 'Large', hp: 126, hp_formula: '12d10 + 60', ac: 17, ac_note: 'Natural Armor', speed: 30, str: 20, dex: 8, con: 20, int: 5, wis: 10, cha: 5, attack_name: 'Slam', attack_bonus: 8, attack_damage: '2d8 + 5', xp: 1800 },
  { id: 'fire-elemental', name: 'Fire Elemental', type: 'Elemental', cr: '5', size: 'Large', hp: 102, hp_formula: '12d10 + 36', ac: 13, speed: 50, str: 10, dex: 17, con: 16, int: 6, wis: 10, cha: 7, attack_name: 'Touch', attack_bonus: 6, attack_damage: '2d6 + 3', xp: 1800 },
  { id: 'water-elemental', name: 'Water Elemental', type: 'Elemental', cr: '5', size: 'Large', hp: 114, hp_formula: '12d10 + 48', ac: 14, ac_note: 'Natural Armor', speed: 30, str: 18, dex: 14, con: 18, int: 5, wis: 10, cha: 8, attack_name: 'Slam', attack_bonus: 7, attack_damage: '2d8 + 4', xp: 1800 },
  { id: 'magmin', name: 'Magmin', type: 'Elemental', cr: '1/2', size: 'Small', hp: 9, hp_formula: '2d6 + 2', ac: 14, ac_note: 'Natural Armor', speed: 30, str: 7, dex: 15, con: 12, int: 8, wis: 11, cha: 10, attack_name: 'Touch', attack_bonus: 4, attack_damage: '2d6', xp: 100 },

  // ── Fey & Constructs ───────────────────────────────────────────────────────
  { id: 'dryad', name: 'Dryad', type: 'Fey', cr: '1', size: 'Medium', hp: 22, hp_formula: '5d8', ac: 11, ac_note: 'Natural Armor', speed: 30, str: 10, dex: 12, con: 11, int: 14, wis: 15, cha: 18, attack_name: 'Club', attack_bonus: 2, attack_damage: '1d4', xp: 200 },
  { id: 'satyr', name: 'Satyr', type: 'Fey', cr: '1/2', size: 'Medium', hp: 31, hp_formula: '7d8', ac: 14, ac_note: 'Natural Armor', speed: 40, str: 12, dex: 16, con: 11, int: 12, wis: 10, cha: 14, attack_name: 'Ram', attack_bonus: 3, attack_damage: '2d4 + 1', xp: 100 },
  { id: 'animated-armor', name: 'Animated Armor', type: 'Construct', cr: '1', size: 'Medium', hp: 33, hp_formula: '6d8 + 6', ac: 18, ac_note: 'Natural Armor', speed: 25, str: 14, dex: 11, con: 13, int: 1, wis: 3, cha: 1, attack_name: 'Slam', attack_bonus: 4, attack_damage: '1d6 + 2', xp: 200 },
  { id: 'flying-sword', name: 'Flying Sword', type: 'Construct', cr: '1/4', size: 'Small', hp: 17, hp_formula: '5d6', ac: 17, ac_note: 'Natural Armor', speed: 0, str: 12, dex: 15, con: 11, int: 1, wis: 5, cha: 1, attack_name: 'Longsword', attack_bonus: 3, attack_damage: '1d8 + 1', xp: 50 },
  { id: 'shield-guardian', name: 'Shield Guardian', type: 'Construct', cr: '7', size: 'Large', hp: 142, hp_formula: '15d10 + 60', ac: 17, ac_note: 'Natural Armor', speed: 30, str: 18, dex: 8, con: 18, int: 7, wis: 10, cha: 3, attack_name: 'Fist', attack_bonus: 7, attack_damage: '2d6 + 4', xp: 2900 },

  // ── Dragons (young) ───────────────────────────────────────────────────────
  { id: 'young-black-dragon', name: 'Young Black Dragon', type: 'Dragon', cr: '7', size: 'Large', hp: 127, hp_formula: '15d10 + 45', ac: 18, ac_note: 'Natural Armor', speed: 40, str: 19, dex: 14, con: 17, int: 12, wis: 11, cha: 15, attack_name: 'Bite', attack_bonus: 7, attack_damage: '2d10 + 4', xp: 2900 },
  { id: 'young-white-dragon', name: 'Young White Dragon', type: 'Dragon', cr: '6', size: 'Large', hp: 133, hp_formula: '14d10 + 56', ac: 17, ac_note: 'Natural Armor', speed: 40, str: 18, dex: 10, con: 18, int: 6, wis: 11, cha: 12, attack_name: 'Bite', attack_bonus: 6, attack_damage: '2d10 + 4', xp: 2300 },
  { id: 'young-green-dragon', name: 'Young Green Dragon', type: 'Dragon', cr: '8', size: 'Large', hp: 136, hp_formula: '16d10 + 48', ac: 18, ac_note: 'Natural Armor', speed: 40, str: 19, dex: 12, con: 17, int: 16, wis: 13, cha: 15, attack_name: 'Bite', attack_bonus: 7, attack_damage: '2d10 + 4', xp: 3900 },
  { id: 'young-blue-dragon', name: 'Young Blue Dragon', type: 'Dragon', cr: '9', size: 'Large', hp: 152, hp_formula: '16d10 + 64', ac: 18, ac_note: 'Natural Armor', speed: 40, str: 21, dex: 10, con: 19, int: 14, wis: 13, cha: 17, attack_name: 'Bite', attack_bonus: 9, attack_damage: '2d10 + 5', xp: 5000 },

  // ── Monstrosities ────────────────────────────────────────────────────────
  { id: 'displacer-beast', name: 'Displacer Beast', type: 'Monstrosity', cr: '3', size: 'Large', hp: 85, hp_formula: '10d10 + 30', ac: 13, ac_note: 'Natural Armor', speed: 40, str: 18, dex: 15, con: 16, int: 6, wis: 12, cha: 8, attack_name: 'Tentacle', attack_bonus: 6, attack_damage: '1d6 + 4', xp: 700 },
  { id: 'manticore', name: 'Manticore', type: 'Monstrosity', cr: '3', size: 'Large', hp: 68, hp_formula: '8d10 + 24', ac: 14, ac_note: 'Natural Armor', speed: 30, str: 17, dex: 16, con: 17, int: 7, wis: 12, cha: 8, attack_name: 'Claws', attack_bonus: 5, attack_damage: '2d6 + 3', xp: 700 },
  { id: 'griffon', name: 'Griffon', type: 'Monstrosity', cr: '2', size: 'Large', hp: 59, hp_formula: '7d10 + 21', ac: 12, speed: 30, str: 18, dex: 15, con: 16, int: 2, wis: 13, cha: 8, attack_name: 'Beak', attack_bonus: 6, attack_damage: '1d8 + 4', xp: 450 },
  { id: 'peryton', name: 'Peryton', type: 'Monstrosity', cr: '2', size: 'Medium', hp: 33, hp_formula: '6d8 + 6', ac: 13, ac_note: 'Natural Armor', speed: 20, str: 16, dex: 12, con: 13, int: 9, wis: 12, cha: 10, attack_name: 'Gore', attack_bonus: 5, attack_damage: '1d8 + 3', xp: 450 },
  { id: 'roper', name: 'Roper', type: 'Monstrosity', cr: '5', size: 'Large', hp: 93, hp_formula: '11d10 + 33', ac: 20, ac_note: 'Natural Armor', speed: 10, str: 18, dex: 8, con: 17, int: 7, wis: 16, cha: 6, attack_name: 'Bite', attack_bonus: 7, attack_damage: '4d8 + 4', xp: 1800 },
  { id: 'bulette', name: 'Bulette', type: 'Monstrosity', cr: '5', size: 'Large', hp: 94, hp_formula: '9d10 + 45', ac: 17, ac_note: 'Natural Armor', speed: 40, str: 19, dex: 11, con: 21, int: 2, wis: 10, cha: 5, attack_name: 'Bite', attack_bonus: 7, attack_damage: '4d12 + 4', xp: 1800 },
  { id: 'wyvern', name: 'Wyvern', type: 'Dragon', cr: '6', size: 'Large', hp: 110, hp_formula: '13d10 + 39', ac: 13, ac_note: 'Natural Armor', speed: 20, str: 19, dex: 10, con: 16, int: 5, wis: 12, cha: 6, attack_name: 'Bite', attack_bonus: 7, attack_damage: '2d6 + 4', xp: 2300 },
  { id: 'naga-spirit', name: 'Spirit Naga', type: 'Monstrosity', cr: '8', size: 'Large', hp: 75, hp_formula: '10d10 + 20', ac: 15, ac_note: 'Natural Armor', speed: 40, str: 18, dex: 17, con: 14, int: 16, wis: 15, cha: 16, attack_name: 'Bite', attack_bonus: 7, attack_damage: '1d6 + 4', xp: 3900 },
];
