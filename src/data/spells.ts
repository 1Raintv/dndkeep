...
export const SPELLS: SpellData[] = [
  ...
  concentration: false,
  ritual: false,
  // v2.691.0 — Artificer dropped: Mending is not on the Artificer cantrip list
  // in Eberron: Forge of the Artificer. Checked against that book's
  // CANTRIPS (LEVEL 0 ARTIFICER SPELLS) table, 2026-08-29.
  ...
  save_type: "WIS",
  damage_type: "Psychic",
  damage_at_char_level: { "1": "1d4", "5": "2d4", "11": "3d4", "17": "4d4" },
  damage_dice: "1d4",
  },
  {
  id: "alarm",
  ...
  concentration: false,
  ritual: false,
  classes: ["Bard", "Druid", "Ranger", "Psion"],
  ...
  concentration: false,
  ritual: false,
  classes: ["Bard", "Druid", "Sorcerer", "Warlock", "Wizard", "Psion"],
  ...
  concentration: true,
  ritual: true,
  classes: ["Artificer", "Bard", "Cleric", "Druid", "Paladin", "Psion", "Ranger", "Sorcerer", "Warlock", "Wizard"],
  ...
  concentration: false,
  ritual: false,
  classes: ["Bard", "Druid", "Sorcerer", "Wizard", "Psion"],
  ...
  higher_levels: "If you cast this spell using a spell slot of 3nd level or higher, the duration of the spell increases by 48 hours for each slot level above 2nd.",
  },
  {
  id: "arcane-lock",
  name: "Arcane Lock",
  ...
  concentration: true,
  ritual: false,
  classes: ["Artificer", "Bard", "Cleric", "Druid", "Psion", "Ranger", "Sorcerer", "Wizard"],
  ...
  damage_type: "Fire",
  damage_at_slot_level: { "2": "3d6", "4": "4d6", "6": "5d6", "8": "6d6" },
  damage_dice: "3d6",
  },
  {
  id: "flaming-sphere",
  ...
  save_type: "CON",
  damage_type: "Fire",
  damage_at_slot_level: { "2": "2d8", "3": "3d8", "4": "4d8", "5": "5d8", "6": "6d8", "7": "7d8", "8": "8d8", "9": "9d8" },
  damage_dice: "2d8",
  },
  {
  id: "hold-person",
  ...
  concentration: true,
  ritual: false,
  classes: ["Bard", "Cleric", "Druid", "Sorcerer", "Warlock", "Wizard", "Psion"],
  ...
  higher_levels: "When you cast this spell using a spell slot of 3rd level or higher, the damage increases by 1dl0 for each slot level above 2nd.",
  save_type: "CON",
  damage_type: "Radiant",
  damage_at_slot_level: {
    "2": "2d10",
  ...
  higher_levels: "When you cast this spell using a 3 or higher level spell slot, the damage of the spell increases by 1d8 for each level of higher spell slot 2.",
  save_type: "CON",
  damage_type: "Thunder",
  damage_at_slot_level: { "2": "3d8", "3": "4d8", "4": "5d8", "5": "6d8", "6": "7d8", "7": "8d8", "8": "9d8", "9": "10d8" },
  damage_dice: "3d8",
  ...
  concentration: true,
  ritual: true,
  classes: ["Bard", "Cleric", "Ranger", "Psion"],
  ...
  higher_levels: "When you cast this spell using a spell slot of 3rd level or higher, the damage increases by 1d8 for every two slot levels above the 2nd.",
  attack_type: "melee",
  damage_type: "Force",
  damage_at_slot_level: {
    "2": "1d8 + MOD",
  ...
  concentration: true,
  ritual: false,
  classes: ["Bard", "Cleric", "Wizard", "Psion"],
  ...
  concentration: false,
  ritual: false,
  classes: ["Bard", "Ranger", "Wizard", "Psion"],
  ...
  concentration: false,
  ritual: false,
  classes: ["Bard", "Cleric", "Sorcerer", "Warlock", "Wizard", "Psion"],
  ...
  concentration: true,
  ritual: false,
  classes: ["Cleric", "Paladin", "Sorcerer", "Warlock", "Wizard", "Psion"],
  ...
  higher_levels: "When you cast this spell using a spell slot of 5th level or higher, the radius of the sphere increases by 5 feet for each slot level above 4th.",
  save_type: "WIS",
  area_of_effect: { type: "sphere", size: 10 },
  },
  {
  ...
  concentration: false,
  ritual: false,
  // v2.691.0 — on the Level 4 Artificer list in Eberron: Forge of the
  // Artificer, printed there as Mordenkainen's Faithful Hound.
  classes: ["Artificer", "Wizard"],
  ...
  concentration: false,
  ritual: false,
  classes: ["Bard", "Druid", "Warlock", "Wizard", "Psion"],
  ...
  concentration: true,
  ritual: false,
  classes: ["Bard", "Cleric", "Druid", "Paladin", "Ranger", "Wizard", "Psion"],
  ...
  damage_at_slot_level: { "2": "4d4", "3": "6d4", "4": "8d4", "5": "10d4", "6": "12d4", "7": "14d4", "8": "16d4", "9": "18d4" },
  damage_dice: "4d4",
  ...
  concentration: false,
  ritual: false,
  classes: ["Bard", "Warlock", "Wizard", "Psion"],
  ...
  save_type: "DEX",
  damage_type: "Fire",
  damage_at_slot_level: { "5": "4d6 + 4d6", "6": "4d6 + 5d6", "7": "4d6 + 6d6", "8": "4d6 + 7d6", "9": "4d6 + 8d6" },
  damage_dice: "4d6 + 4d6",
  area_of_effect: { type: "cylinder", size: 40 },
  },
  {
  ...
  concentration: false,
  ritual: false,
  classes: ["Bard", "Cleric", "Druid", "Paladin", "Wizard", "Psion"],
  ...
  higher_levels: "When you cast this spell using a level 6 or higher location, you can target an additional creature for each level of location beyond the fifth. The creatures must be within 30 feet o f each other when you target them.",
  save_type: "WIS",
  },
  {
  id: "insect-plague",
  ...
  save_type: "CON",
  damage_type: "Piercing",
  damage_at_slot_level: { "5": "4d10", "6": "5d10", "7": "6d10", "8": "7d10", "9": "8d10" },
  damage_dice: "4d10",
  area_of_effect: { type: "sphere", size: 20 },
  },
  {
  ...
  concentration: true,
  ritual: false,
  classes: ["Bard", "Cleric", "Druid", "Warlock", "Wizard", "Psion"],
  ...
  concentration: true,
  ritual: false,
  classes: ["Druid", "Sorcerer", "Wizard", "Psion"],
  ...
  concentration: false,
  ritual: false,
  classes: ["Bard", "Druid", "Wizard", "Psion"],
  ...
  concentration: false,
  ritual: false,
  classes: ["Cleric", "Druid", "Sorcerer", "Warlock", "Wizard", "Psion"],
  ...
  concentration: false,
  ritual: false,
  classes: ["Cleric", "Warlock", "Wizard", "Psion"],
  ...
  // =================================================================
  // UA 2025 Psion spells — added in v2.18.0
  // Sources: 2024 Player's Handbook (returning spells), UA 2025 Psion v2 PDF (new spells)
  // =================================================================
  {
  id: "blade-ward",
  name: "Blade Ward",
  ...
  ritual: false,
  classes: ["Bard", "Sorcerer", "Warlock", "Wizard", "Psion"],
  description: "One Humanoid of your choice that you can see within range must succeed on a Wisdom saving throw or have the Charmed condition for the duration. While Charmed, the target has a twisted crown of jagged iron appear on its head, and a madness glows within its eyes. The Charmed target must use its action before moving on each of its turns to make a melee attack against a creature other than itself that you mentally choose. The target can act normally on its turn if you choose no creature or if none are within its reach. On your subsequent turns, you must take a Magic action to maintain control of the target, or the spell ends. Also, the target can make a Wisdom saving throw at the end of each of its turns. On a success, the spell ends.",
  save_type: "WIS",
  },
  {
  id: "ectoplasmic-trail",
  ...
  damage_type: "Necrotic",
  damage_at_slot_level: { "2": "2d8", "3": "2d8", "4": "2d8", "5": "2d8", "6": "2d8", "7": "2d8", "8": "2d8", "9": "2d8" },
  },
  {
  id: "ego-whip",
  name: "Ego Whip",
  level: 2,
  school: "Enchantment",
  casting_time: "1 reaction, which you take when a creature you can see within 30 feet of yourself makes a Charisma-based ability check or saving throw",
  range: "120 feet",
  components: "V",
  duration: "Instantaneous",
  concentration: false,
  ...
  ritual: false,
  classes: ["Sorcerer", "Warlock", "Wizard", "Psion"],
  description: "You reach into the mind of one creature you can see within range. The target must make a Wisdom saving throw, taking 3d8 Psychic damage on a failed save, or half as much damage on a successful one. On a failed save, you also always know the target's location until the spell ends, but only while the two of you are on the same plane of existence. While you have this knowledge, the target can't become Hidden from you, and if it has the Invisible condition, it gains no benefit from that condition against you.",
  ...
  ritual: false,
  classes: ["Bard", "Sorcerer", "Wizard", "Psion"],
  description: "You craft an illusion that takes root in the mind of a creature you can see within range. The target must succeed on an Intelligence saving throw or be affected by the spell for the duration. The illusion includes audio, visual, tactile, and olfactory elements, but it can't create a sensation of pain. The target perceives the illusion as a real phenomenon. The illusion is tailored to the target, which ignores or rationalizes any sensory information that contradicts the illusion. While affected, the target treats the phantasm as real and rationalizes any illogical outcomes from interacting with it. While the spell lasts, the target takes 1d6 Psychic damage at the start of each of its turns from interacting with the illusion. The target can repeat the saving throw at the end of each of its turns, ending the spell on itself on a success.",
  damage_type: "Psychic",
  save_type: "INT",
  },
  {
  ...
  damage_type: "Psychic",
  save_type: "INT",
  damage_at_slot_level: { "2": "3d6", "3": "3d6", "4": "3d6", "5": "3d6", "6": "3d6", "7": "3d6", "8": "3d6", "9": "3d6" },
  },
  {
  id: "bleeding-darkness",
  ...
  damage_type: "Force",
  save_type: "STR",
  damage_at_slot_level: { "3": "5d6", "4": "6d6", "5": "7d6", "6": "8d6", "7": "9d6", "8": "10d6", "9": "11d6" },
  area_of_effect: { type: "cube", size: 30 },
  },
  {
  id: "charm-monster",
  ...
  ritual: false,
  classes: ["Bard", "Druid", "Sorcerer", "Warlock", "Wizard", "Psion"],
  description: "You attempt to charm a creature you can see within range. It must make a Wisdom saving throw, and it does so with Advantage if you or your allies are fighting it. If it fails the save, it has the Charmed condition for the duration or until you or your allies damage it. The Charmed creature is friendly to you. When the spell ends, the creature knows it was Charmed by you.",
  higher_levels: "You can target one additional creature for each spell slot level above 4.",
  save_type: "WIS",
  },
  {
  id: "life-inversion-field",
  ...
  save_type: "CON",
  heal_dice: "4d8",
  heal_at_slot_level: { "4": "4d8", "5": "5d8", "6": "6d8", "7": "7d8", "8": "8d8", "9": "9d8" },
  },
  {
  ...
  damage_type: "Psychic",
  save_type: "INT",
  damage_at_slot_level: { "4": "7d6", "5": "8d6", "6": "9d6", "7": "10d6", "8": "11d6", "9": "12d6" },
  },
  {
  ...
  ritual: true,
  classes: ["Bard", "Psion", "Wizard"],
  description: "You forge a telepathic link among up to eight willing creatures of your choice within range, psychically linking each creature to all the others for the duration. Creatures with an Intelligence score of 2 or less aren't affected by this spell. Until the spell ends, the targets can communicate telepathically through the bond whether or not they have a common language. The communication is possible over any distance, though it can't extend to other planes of existence.",
  },
  {
  id: "synaptic-static",
  ...
  ritual: false,
  classes: ["Bard", "Sorcerer", "Warlock", "Wizard", "Psion"],
  description: "You choose a point within range and cause psychic energy to explode there. Each creature in a 20-foot-radius Sphere centered on that point must make an Intelligence saving throw. A creature takes 8d6 Psychic damage on a failed save, or half as much damage on a successful one. On a failed save, a target also has muddled thoughts for 1 minute. During that time, it rolls a d6 and subtracts the number rolled from all attack rolls and ability checks, as well as Constitution saving throws to maintain Concentration. The target can make an Intelligence saving throw at the end of each of its turns, ending the effect on itself on a success.",
  damage_type: "Psychic",
  save_type: "INT",
  ...
  damage_type: "Psychic",
  save_type: "INT",
  damage_at_slot_level: { "6": "6d8", "7": "7d8", "8": "8d8", "9": "9d8" },
  area_of_effect: { type: "cone", size: 60 },
  },
  {
  id: "thought-form",
  ...
  ritual: false,
  classes: ["Sorcerer", "Wizard", "Psion"],
  description: "You draw the moisture from every creature in a 30-foot Cube centered on a point within range. Each creature in that area makes a Constitution saving throw, taking 12d8 Necrotic damage on a failed save or half as much damage on a successful one. Constructs automatically succeed at the save, and Plant creatures automatically fail the save. Nonmagical plants in the area that aren't creatures, such as trees and shrubs, wither and die instantly.",
  damage_type: "Necrotic",
  save_type: "CON",
  ...
  description: "You blast the mind of one creature you can see within range with psychic energy, permanently wiping away its mind and intellect. The target must make an Intelligence saving throw, taking 10d12 Psychic damage on a failed save or half as much damage on a successful one. If the failed save reduces the target to 0 Hit Points, the target's mind is wiped clean — it has the Stunned condition for 1 hour, after which the target's Intelligence and Charisma scores both become 1, and it loses the ability to cast spells, understand language, or communicate intelligibly. The target can be restored only by a Greater Restoration, Heal, or Wish spell.",
  damage_type: "Psychic",
  save_type: "INT",
  damage_at_slot_level: { "8": "10d12", "9": "10d12" },
  },
  {
  id: "telepathy",
  name: "Telepathy",
  ...
  ritual: false,
  classes: ["Sorcerer", "Wizard"],
  description: "You hurl a 4-inch-diameter sphere of energy at a target within range. Choose Acid, Cold, Fire, Lightning, Poison, or Thunder for the type of orb you create, and then make a ranged spell attack against the target. On a hit, the target takes 3d8 damage of the chosen type.\n\nIf you roll the same number on two or more of the d8s, the orb leaps to a different target of your choice within 30 feet of the target. Make an attack roll against the new target, and make a new damage roll. The orb can't leap again unless you cast the spell with a spell slot of 2nd level or higher.",
  higher_levels: "When you cast this spell using a spell slot of 2nd level or higher, the damage increases by 1d8 for each slot level above 1st, and the orb can leap once more per slot level above 1st.",
  attack_type: "ranged",
  damage_type: "Acid/Cold/Fire/Lightning/Poison/Thunder",
  damage_at_slot_level: { "1": "3d8", "2": "4d8", "3": "5d8", "4": "6d8", "5": "7d8", "6": "8d8", "7": "9d8", "8": "10d8", "9": "11d8" },
  damage_dice: "3d8",
  },
  {
  id: "witch-bolt",
  ...
  ritual: false,
  classes: ["Sorcerer", "Warlock", "Wizard"],
  description: "A beam of crackling, blue energy lances out toward a target within range. Make a ranged spell attack against the target. On a hit, the target takes 2d12 lightning damage, and on each of your turns for the duration, you can use a Bonus Action to deal 2d12 lightning damage to the target automatically. The spell ends if the target is ever outside the spell's range or if it has Total Cover from you.",
  higher_levels: "When you cast this spell using a spell slot of 2nd level or higher, the initial damage and the Bonus Action damage both increase by 1d12 for each slot level above 1st.",
  attack_type: "ranged",
  damage_type: "Lightning",
  damage_at_slot_level: { "1": "2d12", "2": "3d12", "3": "4d12", "4": "5d12", "5": "6d12", "6": "7d12", "7": "8d12", "8": "9d12", "9": "10d12" },
  damage_dice: "2d12",
  },
  {
  id: "arms-of-hadar",
  ...
  save_type: "STR",
  damage_type: "Necrotic",
  damage_at_slot_level: { "1": "2d6", "2": "3d6", "3": "4d6", "4": "5d6", "5": "6d6", "6": "7d6", "7": "8d6", "8": "9d6", "9": "10d6" },
  damage_dice: "2d6",
  area_of_effect: { type: "sphere", size: 10 },
  },
  {
  ...
  ritual: false,
  classes: ["Paladin"],
  description: "The next time you hit a creature with a weapon or an Unarmed Strike during the spell's duration, the target takes an extra 1d6 fire damage from the attack, and the target must succeed on a Constitution saving throw or be set alight with magical flames. Until the spell ends, the target must make a Constitution saving throw at the start of each of its turns. On a failed save, it takes 1d6 fire damage; on a successful save, the spell ends on the target. A creature can use an action to extinguish the flames with water or by similar means.",
  higher_levels: "When you cast this spell using a spell slot of 2nd level or higher, both the initial fire damage and the recurring fire damage increase by 1d6 for each slot level above 1st.",
  save_type: "CON",
  damage_type: "Fire",
  damage_at_slot_level: { "1": "1d6", "2": "2d6", "3": "3d6", "4": "4d6", "5": "5d6", "6": "6d6", "7": "7d6", "8": "8d6", "9": "9d6" },
  damage_dice: "1d6",
  ...
  ritual: false,
  classes: ["Paladin"],
  description: "The next time you hit a creature with a weapon or an Unarmed Strike during the spell's duration, your attack deals an extra 2d6 thunder damage, and the target must succeed on a Strength saving throw or be pushed 10 feet away from you and be knocked Prone. A thunderous boom accompanies the hit, audible out to 300 feet.",
  ...
  ritual: false,
  classes: ["Paladin"],
  description: "The next time you hit a creature with a weapon or an Unarmed Strike during the spell's duration, your attack deals an extra 1d6 psychic damage, and the target must succeed on a Wisdom saving throw or have the Frightened condition until the spell ends. As an action, the affected target can make a Wisdom check against your spell save DC to steel its resolve and end the spell.",
  higher_levels: "When you cast this spell using a spell slot of 2nd level or higher, the extra damage increases by 1d6 for each slot level above 1st.",
  save_type: "WIS",
  damage_type: "Psychic",
  damage_at_slot_level: { "1": "1d6", "2": "2d6", "3": "3d6", "4": "4d6", "5": "5d6", "6": "6d6", "7": "7d6", "8": "8d6", "9": "9d6" },
  ...
  damage_type: "Psychic",
  damage_at_slot_level: { "2": "2d8", "3": "3d8", "4": "3d8", "5": "4d8", "6": "4d8", "7": "5d8", "8": "5d8", "9": "5d8" },
  damage_dice: "2d8",
  },
  {
  id: "hunger-of-hadar",
  ...
  higher_levels: "When you cast this spell using a spell slot of 4th level or higher, the cold damage and acid damage each increase by 1d6 for each slot level above 3rd.",
  save_type: "DEX",
  damage_type: "Cold",
  damage_at_slot_level: { "3": "2d6", "4": "3d6", "5": "4d6", "6": "5d6", "7": "6d6", "8": "7d6", "9": "8d6" },
  damage_dice: "2d6",
  area_of_effect: { type: "sphere", size: 20 },
  },
  {
  ...
  ritual: false,
  classes: ["Paladin"],
  description: "The next time you hit a creature with a weapon or an Unarmed Strike during the spell's duration, your weapon flares with a bright light, and the attack deals an extra 3d8 radiant damage to the target. Additionally, the target must succeed on a Constitution saving throw or have the Blinded condition until the spell ends. A creature Blinded by this spell can repeat the save at the end of each of its turns, ending the effect on itself on a success.",
  higher_levels: "When you cast this spell using a spell slot of 4th level or higher, the extra damage increases by 1d8 for each slot level above 3rd.",
  save_type: "CON",
  damage_type: "Radiant",
  damage_at_slot_level: { "3": "3d8", "4": "4d8", "5": "5d8", "6": "6d8", "7": "7d8", "8": "8d8", "9": "9d8" },
  damage_dice: "3d8",
  ...
  ritual: false,
  classes: ["Paladin"],
  description: "The next time you hit a creature with a weapon or an Unarmed Strike during the spell's duration, your weapon pierces body and mind, and the attack deals an extra 4d6 psychic damage to the target. The target must succeed on a Wisdom saving throw or have disadvantage on attack rolls and ability checks and be unable to take Reactions until the end of its next turn.",
  higher_levels: "When you cast this spell using a spell slot of 5th level or higher, the extra damage increases by 1d6 for each slot level above 4th.",
  save_type: "WIS",
  damage_type: "Psychic",
  damage_at_slot_level: { "4": "4d6", "5": "5d6", "6": "6d6", "7": "7d6", "8": "8d6", "9": "9d6" },
  damage_dice: "4d6",
  },
  {
  id: "banishing-smite",
  ...
  ritual: false,
  classes: ["Paladin"],
  description: "The next time you hit a creature with a weapon or an Unarmed Strike during the spell's duration, your weapon crackles with force, and the attack deals an extra 5d10 force damage to the target. Additionally, if the target has 50 hit points or fewer after taking this damage, you banish it. If the target is native to a different plane of existence than the one you're on, the target disappears, returning to its home plane. If the target is native to the plane you're on, the target vanishes into a harmless demiplane for 1 minute. While there, the target is Incapacitated. When the spell ends, the target reappears in the space it left or in the nearest unoccupied space if that space is occupied.",
  damage_type: "Force",
  damage_at_slot_level: { "5": "5d10" },
  damage_dice: "5d10",
  higher_levels: "No effect — Banishing Smite does not gain additional damage from a higher-level spell slot; the banishment threshold remains 50 HP regardless of slot level.",
  },
  {
  id: "toll-the-dead",
  name: "Toll the Dead",
  ...
  save_type: "WIS",
  damage_type: "Necrotic",
  damage_at_char_level: { "1": "1d8/1d12", "5": "2d8/2d12", "11": "3d8/3d12", "17": "4d8/4d12" },
  damage_dice: "1d8",
  },
  {
  id: "frostbite",
  ...
  higher_levels: "When you cast this spell using a spell slot of 2nd level or higher, each target takes 1d6 extra damage of the type rolled for each slot level above 1st.",
  attack_type: "ranged",
  damage_type: "Varies (Acid/Cold/Fire/Force/Lightning/Poison/Psychic/Thunder)",
  damage_at_slot_level: { "1": "2d8+1d6", "2": "2d8+2d6", "3": "2d8+3d6", "4": "2d8+4d6", "5": "2d8+5d6", "6": "2d8+6d6", "7": "2d8+7d6", "8": "2d8+8d6", "9": "2d8+9d6" },
  damage_dice: "2d8+1d6",
  },
  {
  id: "ray-of-sickness",
  ...
  ritual: false,
  classes: ["Sorcerer", "Wizard"],
  description: "A ray of sickening, greenish energy lashes out toward a creature within range. Make a ranged spell attack against the target. On a hit, the target takes 2d8 poison damage and must make a Constitution saving throw. On a failed save, it has the Poisoned condition until the end of your next turn.",
  higher_levels: "When you cast this spell using a spell slot of 2nd level or higher, the damage increases by 1d8 for each slot level above 1st.",
  attack_type: "ranged",
  save_type: "CON",
  damage_type: "Poison",
  ...
  casting_time: "1 action",
  range: "90 feet",
  components: "V, S, M (A feather, a tuft of fur, and a fish tail inside a gilded acorn worth 200+ gp.)",
  duration: "Up to 1 hour",
  concentration: true,
  ritual: false,
  classes: ["Druid", "Ranger"],
  description: "You call forth a Bestial Spirit. It appears in an unoccupied space you can see within range, using the Bestial Spirit stat block. When you cast the spell, choose Air, Land, or Water — the creature resembles a Beast of that type of your choice, which determines certain traits in its stat block.\n\nThe creature is an ally to you and your companions. In combat, it rolls its own initiative and acts on its own turn. It obeys your verbal commands (no action required). If you don't issue any, it takes the Dodge action and uses its move to avoid danger. See the 2024 PHB for the Bestial Spirit stat block.",
  higher_levels: "When you cast this spell using a spell slot of 3rd level or higher, use the higher level wherever the spell's level appears in the stat block (HP, attacks scale).",
  damage_type: "Varies (Piercing/Slashing)",
  damage_at_slot_level: { "2": "1d8+3+PB", "3": "1d8+3+PB", "4": "2d8+3+PB", "5": "2d8+3+PB", "6": "3d8+3+PB", "7": "3d8+3+PB", "8": "4d8+3+PB", "9": "4d8+3+PB" },
  damage_dice: "1d8+3",
  },
  {
  id: "spirit-shroud",
  ...
  ritual: false,
  classes: ["Cleric", "Paladin", "Warlock", "Wizard"],
  description: "You call forth spirits of the dead to haunt your attacks. Until the spell ends, your attacks deal an extra 1d8 damage to any target you hit within 10 feet of you. This damage is Radiant, Necrotic, or Cold (you choose when you cast the spell).\n\nAdditionally, any creature that takes this damage can't regain hit points until the start of your next turn. Also, any enemy that is within 10 feet of you when you cast this spell and when you take the Attack action has its Speed reduced by 10 feet until the end of your next turn.",
  higher_levels: "When you cast this spell using a spell slot of 4th level or higher, the extra damage increases by 1d8 for every two slot levels above 3rd.",
  damage_type: "Radiant or Necrotic or Cold",
  damage_at_slot_level: { "3": "1d8", "4": "1d8", "5": "2d8", "6": "2d8", "7": "3d8", "8": "3d8", "9": "4d8" },
  damage_dice: "1d8",
  },
  {
  ...
  ritual: false,
  classes: ["Cleric", "Wizard"],
  description: "You sacrifice some of your health to mend another creature's injuries. You take 4d8 necrotic damage (not reduced by resistance or immunity), and one creature of your choice that you can see within range regains a number of hit points equal to twice the necrotic damage you take.",
  higher_levels: "When you cast this spell using a spell slot of 4th level or higher, the damage you take increases by 1d8 for each slot level above 3rd (and the healing therefore increases accordingly).",
  damage_type: "Necrotic",
  damage_at_slot_level: { "3": "4d8", "4": "5d8", "5": "6d8", "6": "7d8", "7": "8d8", "8": "9d8", "9": "10d8" },
  damage_dice: "4d8",
  heal_at_slot_level: { "3": "2×(4d8)", "4": "2×(5d8)", "5": "2×(6d8)", "6": "2×(7d8)", "7": "2×(8d8)", "8": "2×(9d8)", "9": "2×(10d8)" },
  heal_dice: "2×(4d8)",
  },
  {
  id: "crusaders-mantle",
  ...
  damage_type: "Radiant",
  damage_at_slot_level: { "3": "1d4" },
  damage_dice: "1d4",
  higher_levels: "No effect — Crusader's Mantle does not benefit from a higher-level spell slot.",
  },
  {
  id: "summon-fey",
  name: "Summon Fey",
  ...
  description: "You call forth a Fey Spirit. It appears in an unoccupied space you can see within range, using the Fey Spirit stat block. When you cast the spell, choose a mood — Fuming, Mirthful, or Tricksy — which shapes some of its traits.\n\nThe creature is an ally to you and your companions. In combat, it rolls its own initiative and acts on its own turn. It obeys your verbal commands (no action required). If none, it Dodges and avoids danger. See the 2024 PHB Fey Spirit stat block.",
  ...
  damage_type: "Force or Psychic",
  damage_at_slot_level: { "3": "2d6+3+PB", "4": "2d6+3+PB", "5": "3d6+3+PB", "6": "3d6+3+PB", "7": "4d6+3+PB", "8": "4d6+3+PB", "9": "5d6+3+PB" },
  damage_dice: "2d6+3",
  },
  {
  id: "summon-undead",
  ...
  casting_time: "1 action",
  range: "90 feet",
  components: "V, S, M (A gilded dirge whistle worth 300+ gp.)",
  duration: "Up to 1 hour",
  concentration: true,
  ritual: false,
  classes: ["Warlock", "Wizard"],
  description: "You call forth an Undead Spirit. It appears in an unoccupied space you can see within range, using the Undead Spirit stat block. When you cast the spell, choose Ghostly, Putrid, or Skeletal — the creature resembles an Undead of that kind, which determines certain traits.\n\nThe creature is an ally to you and your companions. It rolls initiative, takes its own turn, and obeys verbal commands. See the 2024 PHB Undead Spirit stat block.",
  higher_levels: "When you cast this spell using a spell slot of 4th level or higher, use the higher level wherever the spell's level appears in the stat block.",
  damage_type: "Necrotic or Cold or Piercing",
  damage_at_slot_level: { "3": "1d8+3+PB", "4": "2d8+3+PB", "5": "2d8+3+PB", "6": "3d8+3+PB", "7": "3d8+3+PB", "8": "4d8+3+PB", "9": "4d8+3+PB" },
  damage_dice: "1d8+3",
  },
  {
  ...
  casting_time: "1 action",
  range: "90 feet",
  components: "V, S, M (An inky cloud in a gilded vial worth 300+ gp.)",
  duration: "Up to 1 hour",
  concentration: true,
  ritual: false,
  classes: ["Sorcerer", "Warlock", "Wizard"],
  description: "You call forth a Shadowspawn. It appears in an unoccupied space you can see within range, using the Shadow Spirit stat block. When you cast the spell, choose Fury, Despair, or Fear — the creature resembles a horror of that emotion, which determines certain traits.\n\nThe creature is an ally to you and your companions. It rolls initiative and obeys verbal commands. See the 2024 PHB Shadow Spirit stat block.",
  higher_levels: "When you cast this spell using a spell slot of 4th level or higher, use the higher level wherever the spell's level appears in the stat block.",
  damage_type: "Psychic or Cold",
  damage_at_slot_level: { "3": "1d6+3+PB", "4": "2d6+3+PB", "5": "2d6+3+PB", "6": "3d6+3+PB", "7": "3d6+3+PB", "8": "4d6+3+PB", "9": "4d6+3+PB" },
  damage_dice: "1d6+3",
  },
  {
  id: "summon-elemental",
  ...
  casting_time: "1 action",
  range: "90 feet",
  components: "V, S, M (Elemental-matter-embedded crystal worth 400+ gp.)",
  duration: "Up to 1 hour",
  concentration: true,
  ritual: false,
  classes: ["Druid", "Ranger", "Wizard"],
  description: "You call forth an Elemental Spirit. It appears in an unoccupied space you can see within range, using the Elemental Spirit stat block. When you cast the spell, choose Air, Earth, Fire, or Water — the creature resembles an Elemental of that kind, which determines certain traits.\n\nThe creature is an ally to you and your companions. It rolls initiative and obeys verbal commands. See the 2024 PHB Elemental Spirit stat block.",
  ...
  damage_type: "Bludgeoning or Acid or Fire or Cold",
  damage_at_slot_level: { "4": "2d8+4+PB", "5": "2d8+4+PB", "6": "3d8+4+PB", "7": "3d8+4+PB", "8": "4d8+4+PB", "9": "4d8+4+PB" },
  damage_dice: "2d8+4",
  },
  {
  id: "summon-construct",
  ...
  casting_time: "1 action",
  range: "90 feet",
  components: "V, S, M (A 100 gp gem worth 400+ gp total.)",
  duration: "Up to 1 hour",
  concentration: true,
  ritual: false,
  classes: ["Artificer", "Wizard"],
  description: "You call forth a Construct Spirit. It appears in an unoccupied space you can see within range, using the Construct Spirit stat block. When you cast the spell, choose Clay, Metal, or Stone — the creature's form is shaped from that material, which determines certain traits.\n\nThe creature is an ally to you and your companions. It rolls initiative and obeys verbal commands. See the 2024 PHB Construct Spirit stat block.",
  higher_levels: "When you cast this spell using a spell slot of 5th level or higher, use the higher level wherever the spell's level appears in the stat block.",
  damage_type: "Bludgeoning",
  damage_at_slot_level: { "4": "1d10+4+PB", "5": "2d10+4+PB", "6": "2d10+4+PB", "7": "3d10+4+PB", "8": "3d10+4+PB", "9": "4d10+4+PB" },
  damage_dice: "1d10+4",
  },
  {
  id: "summon-celestial",
  ...
  casting_time: "1 action",
  range: "90 feet",
  components: "V, S, M (A gilded reliquary worth 500+ gp.)",
  duration: "Up to 1 hour",
  concentration: true,
  ritual: false,
  classes: ["Cleric", "Paladin"],
  description: "You call forth a Celestial Spirit. It appears in an unoccupied space you can see within range, using the Celestial Spirit stat block. When you cast the spell, choose Avenger (ranged bow attacker) or Defender (melee protector) — this determines certain traits.\n\nThe creature is an ally to you and your companions. It rolls initiative and obeys verbal commands. See the 2024 PHB Celestial Spirit stat block.",
  ...
  damage_type: "Radiant or Piercing",
  damage_at_slot_level: { "5": "2d6+4+PB", "6": "2d6+4+PB", "7": "3d6+4+PB", "8": "3d6+4+PB", "9": "4d6+4+PB" },
  damage_dice: "2d6+4",
  heal_at_slot_level: { "5": "2d6+3" },
  heal_dice: "2d6+3",
  },
  {
  id: "summon-dragon",
  ...
  casting_time: "1 action",
  range: "90 feet",
  components: "V, S, M (An arrowhead and a 500+ gp ruby.)",
  duration: "Up to 1 hour",
  concentration: true,
  ritual: false,
  classes: ["Wizard"],
  description: "You call forth a Draconic Spirit. It appears in an unoccupied space you can see within range, using the Draconic Spirit stat block. When you cast the spell, choose a damage type from Acid, Cold, Fire, Lightning, or Poison. The spirit uses that type for its breath-related abilities.\n\nThe creature is an ally to you and your companions. It rolls initiative and obeys verbal commands. See the 2024 PHB Draconic Spirit stat block.",
  higher_levels: "When you cast this spell using a spell slot of 6th level or higher, use the higher level wherever the spell's level appears in the stat block.",
  damage_type: "Varies (chosen at cast)",
  damage_at_slot_level: { "5": "2d6+4+PB", "6": "3d6+4+PB", "7": "3d6+4+PB", "8": "4d6+4+PB", "9": "4d6+4+PB" },
  damage_dice: "2d6+4",
  },
  {
  id: "summon-fiend",
  ...
  casting_time: "1 action",
  range: "90 feet",
  components: "V, S, M (A vial of blood from a humanoid killed within the last 24 hours worth 600+ gp.)",
  duration: "Up to 1 hour",
  concentration: true,
  ritual: false,
  classes: ["Warlock", "Wizard"],
  description: "You call forth a Fiendish Spirit. It appears in an unoccupied space you can see within range, using the Fiendish Spirit stat block. When you cast the spell, choose Demon, Devil, or Yugoloth — the creature resembles a Fiend of that kind, which determines certain traits.\n\nThe creature is an ally to you and your companions. It rolls initiative and obeys verbal commands. See the 2024 PHB Fiendish Spirit stat block.",
  ...
  damage_type: "Fire or Poison or Piercing",
  damage_at_slot_level: { "6": "3d6+4+PB", "7": "3d6+4+PB", "8": "4d6+4+PB", "9": "4d6+4+PB" },
  damage_dice: "3d6+4",
  },
...
export const SPELL_SCHOOLS: string[] = Array.from(new Set(SPELLS.map(s => s.school).filter(Boolean) as string[])).sort();
