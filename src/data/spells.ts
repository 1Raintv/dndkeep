...
export const SPELLS: SpellData[] = [
  ...
  description: "For the duration, one willing creature you can see within range has Resistance to Psychic damage as well as Advantage on Intelligence, Wisdom, and Charisma saving throws.",
  ...
  casting_time: "1 action",
  range: "90 feet",
  components: "V, S, M (an eyeball encased in gold worth 400+ GP)",
  duration: "Concentration, up to 1 hour",
  concentration: true,
  ritual: false,
  classes: ["Warlock", "Wizard", "Psion"],
  ...
  ritual: false,
  classes: ["Bard", "Cleric", "Sorcerer", "Wizard", "Psion"],
  description: "You speak a word of power that bolsters your allies with vigor and resolve. Choose up to six creatures you can see within range. Each target gains 120 Temporary Hit Points, which last until the spell ends.",
  },
  {
  ...
  ritual: false,
  classes: ["Bard", "Cleric", "Psion"],
  description: "A wave of healing energy washes over a creature you touch. The target regains all its Hit Points. If the creature is Charmed, Frightened, Paralyzed, Stunned, or Unconscious, that condition ends. If the creature has the Prone condition, it can use its Reaction to stand up.",
  },
  {
  id: "psychic-scream",
  name: "Psychic Scream",
