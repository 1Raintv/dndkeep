    ...
    subclasses: [
      {
        ...
        features: [
          { level: 3, name: 'Frenzy', description: "If you use Reckless Attack while Raging, you deal extra damage to the first target you hit on your turn with a Strength-based attack: roll d6s equal to your Rage Damage bonus.", descriptionLong: (c) => { const bonus = c.level >= 16 ? 4 : c.level >= 9 ? 3 : 2; return `If you use Reckless Attack while your Rage is active, you deal extra damage to the first target you hit on your turn with a Strength-based attack. Roll a number of d6s equal to your Rage Damage bonus (${bonus}d6 at your level) and add them together. The extra damage is the same type as the weapon or Unarmed Strike used for the attack.`; }, isChoice: false },
          { level: 6, name: 'Mindless Rage', description: "You have Immunity to the Charmed and Frightened conditions while your Rage is active. If you're Charmed or Frightened when you enter your Rage, the condition ends on you.", isChoice: false },
          ...
          { level: 14, name: 'Intimidating Presence', description: "Bonus Action: each creature of your choice in a 30-foot Emanation must make a Wisdom save (DC 8 + STR mod + Proficiency Bonus) or be Frightened for 1 minute. 1/Long Rest, or expend a Rage use to restore it.", descriptionLong: "As a Bonus Action, you can strike terror into others with your menacing presence and primal power. When you do so, each creature of your choice in a 30-foot Emanation originating from you must make a Wisdom saving throw (DC 8 plus your Strength modifier and Proficiency Bonus). On a failed save, a creature has the Frightened condition for 1 minute. At the end of each of the Frightened creature's turns, the creature repeats the save, ending the effect on itself on a success.\n\nOnce you use this feature, you can't use it again until you finish a Long Rest unless you expend a use of your Rage (no action required) to restore your use of it.", save: { ability: 'WIS', dc: { classAbility: 'STR' }, targetMode: 'enemies' }, isChoice: false },
        ],
      },
      {
  ...
  },
  {
    ...
    subclasses: [
      ...
      },
      {
        ...
        description: "Blend martial training with arcane spells. Bond weapons to your hand and use War Magic to swap attacks for spellcasting mid-swing.",
        features: [
          ...
          { level: 7, name: 'War Magic', description: "When you take the Attack action on your turn, you can replace one of the attacks with a casting of one of your Wizard cantrips that has a casting time of an action.", isChoice: false },
          ...
          { level: 18, name: 'Improved War Magic', description: "When you take the Attack action on your turn, you can replace two of the attacks with a casting of one of your level 1 or level 2 Wizard spells that has a casting time of an action.", isChoice: false },
        ],
      },
      {
