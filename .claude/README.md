...
| `skills/apply-migrations/` | Apply pending migrations: local Docker DB directly; prod via the gated CI workflow (`.github/workflows/migrate.yml`) or Dashboard paste. Encodes the ledger-baseline safety interlock. |
